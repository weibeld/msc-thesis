...
uint32_t MurmurHash2(const char *key, unsigned int len,
  ...
  uint32_t seed = 0xd9a2b873U; // hardcoded seed
...
uint32_t MurmurHash2A (const char *key, unsigned int len,
		       void *foo __attribute__ ((unused))) {
  uint32_t seed = 0xd9a2b873U; // hardcoded seed
  const uint32_t m = 0x5bd1e995U;
  const int r = 24;
...
uint32_t MurmurHashNeutral2(const char *key, unsigned int len,
			    void *foo __attribute__ ((unused))) {
  uint32_t seed = 0xd9a2b873U; // hardcoded seed
  const uint32_t m = 0x5bd1e995U;
  const int r = 24;
...
uint32_t MurmurHashAligned2(const char *key, unsigned int len,
			    void *foo __attribute__ ((unused))) {
  uint32_t seed = 0xd9a2b873U; // hardcoded seed
  const uint32_t m = 0x5bd1e995U;
  const int r = 24;
...
uint64_t MurmurHash64B(const char *key, unsigned int len,
		       void *foo __attribute__ ((unused))) {
  uint64_t seed = 0x3a30766a76eddb2aU; // hardcoded seed
  const uint32_t m = 0x5bd1e995U;
  const int r = 24;
...
uint64_t MurmurHash64A(const char *key, unsigned int len,
		       void *foo __attribute__ ((unused))) {
  uint64_t seed = 0x3a30766a76eddb2aU; // hardcoded seed
