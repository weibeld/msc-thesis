      ...
      while (!pendingStates.isEmpty()) {
        ...
        for (String symbol : inAlphabet) {
          ...
          for (int j = p.numberOfComponents()-1; j >= 0; j--) {
            ...
            //   int qkColor = 999;
            //   StateSet qkStates;
            //   if (t == ACC) qkStates = acc;
            //   else qkStates = nonacc;
          ...
          //if (getOptions().isM2()) {
            ...
            //     if (candidate.color() == 1 && candidate != q.getM2Exclude()) {
            //       q.setM2(candidate);
            //       break;
            //     }
            //   }
