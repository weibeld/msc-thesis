 ...
 * @tail: element that gets appended to the list
 * 
 * Appends an element to the end of a linked list. The linked list must have a
 * NEXT field in its structure in order to be able to use this macro.
 */
 ...
 * 
 * Visits each element of a linked list.
 */
...
/**
 * list_remove:
 * @elt: list element that gets removed
 * @list: list to operate on
 * 
 * Removes the element ELT from the list LIST and isolates it.
 */
 ...
 * @list: head of the linked list
 * 
 * Frees up the memory each element of the linked list occupies.
 */
