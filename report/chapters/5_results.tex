...
- what to expect from automata of size 15 (like automata in goal test set)
- which criteria make automata harder to complement
- evidence that a lower worst-case state complexity does not mean better performance on concrete automata (poor guide to acutal performance)
- no best construction, a construction can only be the best relative to a certain automaton or set of automata
- constructions which are good for one type of automata may be bad for  another type and vice versa
- support for the portfolio approach of selecting an appropriate construction for a specific automaton at hand (CITATION?)
