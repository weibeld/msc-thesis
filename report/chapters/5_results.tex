...
\begin{table}[ht]
\centering
\input{../results/figures/internal/goal/outs.tex}
...
\begin{table}[ht]
\centering
\input{../results/figures/internal/goal/s.stats.tex}
...
\begin{table}[htb]
\centering
\input{../results/figures/internal/michel/s.table.tex}
...
\begin{table}[htb]
\centering
\input{../results/figures/internal/michel/t.table.tex}
...
\begin{table}[ht]
\centering
\input{../results/figures/external/goal/outs.tex}
...
\begin{table}[htb]
\centering
\input{../results/figures/external/goal/s.stats.with_rank.tex}
...
\begin{table}[ht]
\centering
\input{../results/figures/external/goal/s.stats.tex}
...
\centering
  ...
  \begin{subfigure}[t]{\perspwidth\textwidth}
  \centering
  \includegraphics[width=\textwidth]{../results/figures/external/goal/s.median.Piterman+EQ+RO.pdf}
  \caption{Piterman+EQ+RO}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{\perspwidth\textwidth}
  \centering
  \includegraphics[width=\textwidth]{../results/figures/external/goal/s.median.Slice+P+RO+MADJ+EG.pdf}
...
\begin{figure}[htb]
\centering
\input{../results/figures/external/michel/s.table.tex}
...
\begin{table}[htb]
\centering
\input{../results/figures/external/michel/t.table.tex}
