...
\begin{figure}[h]
  ...
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{figures/r/appendices/s.median.Piterman+EQ+RO.tex}
    \caption{Piterman+EQ+RO}
  \end{subtable}
  \hfill
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{figures/r/appendices/s.median.Slice+P+RO+MADJ+EG.tex}
...
\begin{figure}
  ...
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{figures/r/appendices/s.median.Fribourg.tex}
    \caption{Fribourg}
  \end{subtable}
  \hfill
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{figures/r/appendices/s.median.Fribourg+R2C.tex}
  ...
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{figures/r/appendices/s.median.Fribourg+R2C+C.tex}
    \caption{Fribourg+R2C+C}
  \end{subtable}
  \hfill
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{figures/r/appendices/s.median.Fribourg+M1.tex}
    \caption{Fribourg+M1}
  \end{subtable}
  ...
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{figures/r/appendices/s.median.Fribourg+M1+M2.tex}
    \caption{Fribourg+M1+M2}
  \end{subtable}
  \hfill
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{figures/r/appendices/s.median.Fribourg+M1+R2C.tex}
  ...
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{figures/r/appendices/s.median.Fribourg+M1+R2C+C.tex}
    \caption{Fribourg+M1+R2C+C}
  \end{subtable}
  \hfill
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{figures/r/appendices/s.median.Fribourg+R.tex}
    \caption{Fribourg+R}
  \end{subtable}
\end{scriptsize}
