...
\begin{figure}[htb]
  ...
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{../results/figures/external/goal/matrices/s.median.Piterman+EQ+RO.tex}
    \caption{Piterman+EQ+RO}
  \end{subtable}
  \hfill
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{../results/figures/external/goal/matrices/s.median.Slice+P+RO+MADJ+EG.tex}
...
\begin{figure}[ht]
  ...
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{../results/figures/internal/goal/matrices/s.median.Fribourg.tex}
    \caption{Fribourg}
  \end{subtable}
  \hfill
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{../results/figures/internal/goal/matrices/s.median.Fribourg+R2C.tex}
  ...
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{../results/figures/internal/goal/matrices/s.median.Fribourg+R2C+C.tex}
    \caption{Fribourg+R2C+C}
  \end{subtable}
  \hfill
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{../results/figures/internal/goal/matrices/s.median.Fribourg+R.tex}
    \caption{Fribourg+R}
  \end{subtable}
  ...
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{../results/figures/internal/goal/matrices/s.median.Fribourg+M1.tex}
    \caption{Fribourg+M1}
  \end{subtable}
  \hfill
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{../results/figures/internal/goal/matrices/s.median.Fribourg+M1+R2C.tex}
  ...
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{../results/figures/internal/goal/matrices/s.median.Fribourg+M1+R2C+C.tex}
    \caption{Fribourg+M1+R2C+C}
  \end{subtable}
  \hfill
  \begin{subtable}[t]{\subwidth\textwidth}
    \centering
    \input{../results/figures/internal/goal/matrices/s.median.Fribourg+M1+M2.tex}
