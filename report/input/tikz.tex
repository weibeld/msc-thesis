...
\def\myvdistdag{0.95cm} % Vertical distance of levels of run DAG
...
\tikzset{
  ...
  my state small/.style={
    my state,
    rounded corners=1.1mm
  },
  my accepting small/.style={
    double,
    double distance=0.65pt,
    outer sep=0.5pt,
  },
  state height/.style={
    minimum height=1.74em
  },
  automaton/.style={
  ...
  small automaton/.style={
    automaton,
    every state/.style={my state small},
    accepting/.style={my accepting small}
  },
  tree/.style={
  ...
  dag/.style={
    mtrx,
    a/.style={my accepting},
    row sep={\myvdistdag,between origins},
    %column sep=0.75cm,
    column sep=0.5cm,
    inner sep=0mm,
...
%==============================================================================%
\newcommand{\FribourgConstruction}{
\begin{tikzpicture}[tbox/.style={draw,align=center,inner sep=1.3mm}]
\footnotesize
\draw (-0.25,1) node(a)           {$A$}
      (2,1)     node(upper)[tbox]{Upper part\\construction}
      (5,1)     node(lower)[tbox]{Lower part\\construction}
      (7.25,1)  node(b)          {$B$}
      (0.6,0)   rectangle (6.4,2);
\draw[->] (a.east)     -- (upper.west);
\draw[->] (upper.east) -- node[yshift=0.2cm] {$U$} (lower.west);
\draw[->] (lower.east) -- (b.west);
\end{tikzpicture}
}
...
\draw[<->,shorten >=-0.35mm,shorten <=-0.35mm] (0) edge node[above,xshift=2mm,yshift=-2mm] {\labsize $4$} (4);
...
\newcommand{\LevelSymbolsRunDAG}{
\begin{tikzpicture}[tree,every tree node/.style={draw=none},edge from parent/.style={draw=none},l/.style={pos=0.3},level distance=\myvdistdag]
\Tree [ \edge node[l]{$a$}; [ \edge node[l]{$a$}; [ \edge node[l]{$a$}; [ \edge node[l]{$a$}; {} ] ] ] ]
\end{tikzpicture}
}
...
% Model checking tree
%==============================================================================%
\newcommand{\ModelChecking}{
\begin{tikzpicture}[every tree node/.style={minimum height=1.5em},sibling distance=1cm,level distance=1cm]
\footnotesize
\Tree
[.\node{Formal verification}; [.\node{$\dots$}; ]
                              [.\node{Model checking}; [.\node{$\dots$}; ]
                                                       [.\node{Automata-theoretic}; [.\node{$\dots$}; ]
                                                                                    [.\node{Language containment approach}; ] ] ] ]
\end{tikzpicture}
}
...
frame/.style={
    draw,rectangle,
    minimum width=2.125cm,
    minimum height=2em,
    fill=black!5
  },
small automaton,
shorten/.style={shorten >=2.5mm,shorten <=2.5mm}]
\scriptsize
\Tree
[.\node{\qq0}; [.\node(bottomleft) {\qqq02}; ]
               [.\node[a]          {\qq1};   ] ]
\begin{scope}[on background layer]
\node[frame,anchor=west,xshift=-0.7mm] (l1) at (bottomleft.west)          {};
\node[frame]                           (l0) at ($(l1)+(0,\myvdistsmall)$) {};
\end{scope}
\node[state,anchor=east] (s0) at ($(l0.west)-(1.3,0)$) {$(\qm0)$};
\node[state,anchor=west] (s1) at ($(l1.east)+(1.3,0)$) {$(\qqm02,\qm1)$};
\draw[->,shorten] (s0.east) -- (l0.west);
\draw[->,shorten] (l1.east) -- (s1.west);
\end{tikzpicture}
}
...
\node[frame]                           (l0) at ($(l1)+(0,\myvdistsmall)$) {};
\end{scope}
\node[state,anchor=east] (s0) at ($(l0.west)-(1.3,0)$) {$(\qqm02,\qm1)$};
\node[state,anchor=west] (s1) at ($(l1.east)+(1.3,0)$) {$(\qm0, \qm1,\qm2)$};
\draw[->,shorten] (s0.east) -- (l0.west);
\draw[->,shorten] (l1.east) -- (s1.west);
\end{tikzpicture}
}
...
\node[frame]                           (l0) at ($(l1)+(0,\myvdistsmall)$) {};
\end{scope}
\node[state,anchor=east] (s0) at ($(l0.west)-(1.3,0)$) {$(\qm0, \qm1,\qm2)$};
\node[state,anchor=west] (s1) at ($(l1.east)+(1.3,0)$) {$(\qm0, \qm1,\qm2)$};
\draw[->,shorten] (s0.east) -- (l0.west);
\draw[->,shorten] (l1.east) -- (s1.west);
\end{tikzpicture}
...
\matrix[every node/.style={my state,rounded corners=0mm}]{
  \node (00) {\q0}; \& \node[a] (01) {\q1}; \& \node (02) {\q2}; \\
  \node (10) {\q0}; \& \node[a] (11) {\q1}; \& \node (12) {\q2}; \\
  \node (20) {\q0}; \& \node[a] (21) {\q1}; \& \node (22) {\q2}; \\
  \node (30) {\q0}; \& \node[a] (31) {\q1}; \& \node (32) {\q2}; \\
...
\path[->]
  (00) edge          (10) edge[] (11) edge (12)
  (10) edge          (20) edge[] (21) edge (22)
  (11) edge[] (22)
  (12) edge          (22)
  (20) edge          (30) edge[] (31) edge (32)
  (21) edge[] (32)
  (22) edge          (32)
  (30) edge          (40) edge[] (41) edge (42)
  (31) edge[] (42)
  (32) edge          (42);  
...
\begin{tikzpicture}[
  ...
  shorten/.style={shorten >=4mm,shorten <=4mm}
]
\Tree
% [.\node{\qq0}; [.\node{\qqq02}; [.\node(m){\qq0}; [.\node{\qq0}; \node{\qq0};
%                                                             \node[a]{\qq1}; ] 
...
\node[state,anchor=west] (s0) at (level0.east) {$(\qm0)$};
\node[state,anchor=west] (s1) at (level1.east) {$(\qqm02,\qm1)$};
\node[state,anchor=west] (s2) at (level2.east) {$(\qm0,\qm1,\qm2)$};
\node[state,anchor=west] (s3) at (level3.east) {$(\qm0,\qm1,\qm2)$};
\end{scope}
\draw[<->,shorten] (level0.east) -- (s0.west);
\draw[<->,shorten] (level1.east) -- (s1.west);
\draw[<->,shorten] (level2.east) -- (s2.west);
\draw[<->,shorten] (level3.east) -- (s3.west);
...
\begin{tikzpicture}[small automaton,node distance=\myndistsmall]
\scriptsize
\node[state,initial] (0)              {$(\qm0)$};
...
\begin{tikzpicture}[automaton,every state/.style={my state,state height}]
\node[state,initial]   (0)               {$(\cl^{\qm0})$};
\node[state]           (1)  [right=of 0] {$(\cl^{\qqm02},\cl^{\qm1})$};
\node[state]           (2)  [right=of 1] {$(\cl^{\qm0},\cl^{\qm1},\cl^{\qm2})$};
\node[state]           (01) [below=of 0] {$(\qqm02,\cl2{\qm1})$};
...
\begin{tikzpicture}[small automaton,node distance=\myndistsmall,every state/.style={my state small,state height}]
\scriptsize
\node[state,initial]   (0)               {$(\cl^{\qm0})$};
\node[state]           (1)  [right=of 0] {$(\cl^{\qqm02},\cl^{\qm1})$};
\node[state]           (2)  [right=of 1] {$(\cl^{\qm0},\cl^{\qm1},\cl^{\qm2})$};
...
%==============================================================================%
% \newcommand{\PredCompsFirst}{
% \begin{tikzpicture}[small automaton,,tree,level distance=\myvdistsmall,sibling distance=\myhdistsmall,
% every tree node/.append style={fill=white},
% frame/.style={
%     draw,rectangle,
%     minimum width=3.5cm,
...
% \node[frame]                           (l0) at ($(l1)+(0,\myvdistsmall)$) {};
% \end{scope}
% \node[state,anchor=west] (1) at ($(l0.east)+(1.3,0)$) {$(\qm0, \qm1,\qm2)$};
% \node[state,anchor=west] (2) at ($(l1.east)+(1.3,0)$) {$(\qm0, \qm1,\qm2)$};
% \draw[<->,shorten] (l0.east) -- (1.west);
% \draw[<->,shorten] (l1.east) -- (2.west);
...
% \node at ($(1.east)+(2mm,0)$) {$p$};
% \node at ($(2.east)+(2mm,0)$) {$q$};
% \end{tikzpicture}
% }
...
\node[frame]                           (l0) at ($(l1)+(0,\myvdistsmall)$) {};
\end{scope}
\node[state,anchor=east] (1) at ($(l0.west)-(1.3,0)$) {$(\qm0, \qm1,\qm2)$};
\node[state,anchor=east] (2) at ($(l1.west)-(1.3,0)$) {$(\qm0, \qm1,\qm2)$};
\draw[<->,shorten] (l0.west) -- (1.east);
\draw[<->,shorten] (l1.west) -- (2.east);
\draw[densely dotted,small arrow]
($(1.south east)!0.2!(1.south west)+(0,0.9mm)$)
    -- ($(2.north east)!0.2!(2.north west)-(0,1.5mm)$);
\draw[densely dotted,small arrow]
...
($(1.south east)!0.79!(1.south west)+(0,0.9mm)$)
    -- ($(2.north east)!0.79!(2.north west)-(0,1.5mm)$);
\path[->] (1) edge node[right] {$a$} (2);
\node at ($(1.west)-(2.5mm,0)$) {$p$};
\node at ($(2.west)-(2.5mm,0)$) {$q$};
\end{tikzpicture}
}

\newcommand{\PredCompsOne}{
\begin{tikzpicture}[small automaton,node distance=0.3cm]
\scriptsize
\node[state,state height] (1)              {$(\qqm02,\cl2{\qm1})$};
\node[state,state height] (2) [below=of 1] {$(\qm0, \qm1, \qm2)$};
\draw[densely dotted,small arrow]
($(1.south east)!0.23!(1.south west)+(0,0.7mm)$)
    -- ($(2.north east)!0.21!(2.north west)-(0,1.5mm)$);
\draw[densely dotted,small arrow]
($(1.south east)!0.68!(1.south west)+(0,0.7mm)$)
    -- ($(2.north east)!0.51!(2.north west)-(0,1.5mm)$);
\draw[densely dotted,small arrow]
($(1.south east)!0.68!(1.south west)+(0,0.7mm)$)
    -- ($(2.north east)!0.79!(2.north west)-(0,1.5mm)$);
...
\begin{tikzpicture}[small automaton,node distance=0.3cm]
\scriptsize
\node[state,state height] (1)              {$(\qm0,\cl1{\qm1},\cl2{\qm2})$};
\node[state,state height] (2) [below=of 1] {$(\qm0, \qm1, \qm2)$};
\draw[densely dotted,small arrow]
($(1.south east)!0.2!(1.south west)+(0,0.7mm)$)
    -- ($(2.north east)!0.2!(2.north west)-(0,1.5mm)$);
\draw[densely dotted,small arrow]
($(1.south east)!0.79!(1.south west)+(0,0.7mm)$)
    -- ($(2.north east)!0.51!(2.north west)-(0,1.5mm)$);
\draw[densely dotted,small arrow]
($(1.south east)!0.79!(1.south west)+(0,0.7mm)$)
    -- ($(2.north east)!0.79!(2.north west)-(0,1.5mm)$);
...
\begin{tikzpicture}[small automaton,node distance=0.3cm]
\scriptsize
\node[state,state height] (1)              {$(\qm0,\cl2{\qm1}, \qm2)$};
\node[state,state height] (2) [below=of 1] {$(\qm0, \qm1, \qm2)$};
\draw[densely dotted,small arrow]
($(1.south east)!0.2!(1.south west)+(0,0.7mm)$)
    -- ($(2.north east)!0.2!(2.north west)-(0,1.5mm)$);
...
\newcommand{\PredCompsFour}{
\begin{tikzpicture}[small automaton,node distance=0.3cm]
\scriptsize
\node[state,state height] (1)              {$(\qm0,\cl1{\qm1}, \qm2)$};
\node[state,state height] (2) [below=of 1] {$(\qm0, \qm1, \qm2)$};
\draw[densely dotted,small arrow]
($(1.south east)!0.2!(1.south west)+(0,0.7mm)$)
    -- ($(2.north east)!0.2!(2.north west)-(0,1.5mm)$);
