...
% Preamble
%==============================================================================%
% Options: table: table option for package 'xcolor' for colouring table cells
...
First of all, I would like to thank my supervisors Prof. Ulrich Ultes-Nitsche and Joel Allred for their support and patience during the during the entire development time of this thesis. A very special thanks goes to Dr. Ming-Hsien Tsai from National Taiwan University. He is one of the main authors of the \goal tool and provided very prompt help regarding implementation details of \goal. Without this information, the \goal-plugin, which I developed as part of the thesis, would not have been possible in its present form. I am especially thankful to thank Assoc. Prof. Katarzyna Wac from the University of Geneva for granting me large amounts of free time from my employment in her research group. Without this extra time, it would have been very difficult to complete the thesis within the deadlines of the university. Last but not least, I thank Michael Rolli and Nico Färber from the Grid Admin Team of the University of Bern for providing very helpful support regarding technical issues about the computer cluster on which I executed the experiments of this thesis.
\end{abstract}
